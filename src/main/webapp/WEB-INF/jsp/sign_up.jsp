    ...
    <div class="main">
        ...
        <h4 class="title">
            ...
            <div class="normal-title">
                ...
                <b> · </b>
                <a id="js-sign-up-btn" class="active" href="/sign_up">
                    注册
                </a>
            </div>
        ...
        <div class="js-sign-in-container">
            ...
            <form id="new_session" action="/doRegister" method="post">
                <br>
                <div class="input-prepend restyle">
                    <input type="text" name="userName" id="user_nickname" placeholder="你的昵称">
                ...
                <div class="input-prepend restyle js-normal">
                    <input type="tel" name="phone" id="user_mobile_number" placeholder="手机号">
                    <i class="iconfont ic-phonenumber">
                    </i>
                </div>


                <div class="input-prepend restyle js-normal">
                    <input type="password" name="password" id="user_password" placeholder="设置密码"><br>
                    <i class="iconfont ic-password">
                    </i>
                </div>


                <input class="sign-in-button" type="submit" value="注册" style="pointer-events: auto;">
